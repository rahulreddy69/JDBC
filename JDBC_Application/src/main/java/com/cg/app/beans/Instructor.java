...
public class Instructor implements Comparable<Instructor>{
	...
	public Instructor(int instructorCode, String name, int salary, int jobStartYear, String email, String trainerLocation) {
		super();
	...
	public int compareTo(Instructor o) {
		...
		return this.getInstructorCode() - o.getInstructorCode();
	}
